...
export class Backend implements backendInterface {
    ...
    async filterByCategory(arg0: string): Promise<Array<Video>> {
        if (this.processError) {
            try {
    ...
    async getVideoAnalytics(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVideoAnalytics();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markPremium(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markPremium(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async viewVideo(arg0: string): Promise<Video> {
        if (this.processError) {
            try {
                const result = await this.actor.viewVideo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
