...
export interface _SERVICE {
  ...
  'filterByCategory' : ActorMethod<[string], Array<Video>>,
  ...
  'getVideoAnalytics' : ActorMethod<[], Array<[string, bigint]>>,
  'getWatchHistory' : ActorMethod<[], Array<string>>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'isPremium' : ActorMethod<[], boolean>,
  'isStripeConfigured' : ActorMethod<[], boolean>,
  'markPremium' : ActorMethod<[Principal], undefined>,
  ...
  'viewVideo' : ActorMethod<[string], Video>,
}
